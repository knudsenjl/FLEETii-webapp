...
/** Maps a Postgres unique_violation (23505) on the costumers_cvr_unique constraint (see supabase/applied/costumers_cvr_unique.sql) to a Danish message a FLEETii admin can act on, instead of the raw driver error. */
